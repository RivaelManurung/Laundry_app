...
@section('header-title', 'Registrasi Pelanggan')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="px-8 py-5 border-b border-gray-100 bg-gray-50/50">
            <h3 class="text-base font-semibold leading-6 text-gray-900">Form Data Diri</h3>
            <p class="mt-1 text-sm text-gray-500">Lengkapi informasi di bawah ini untuk mendaftarkan pelanggan baru.</p>
        </div>
                    ...
                    <div class=" sm:col-span-2">
                        ...
                        <div class="relative mt-2">
                            <textarea name="address" id="address" rows="4"
                                class="block w-full rounded-lg border-0 py-2.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 transition duration-150 ease-in-out resize-none"></textarea>
                        </div>
